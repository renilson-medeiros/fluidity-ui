...
export function FloatingNav() {
  ...
  return (
    <div className="w-full h-[400px] relative rounded-lgoverflow-hidden">
        
        <div className="absolute top-0 left-0 w-full z-50 pointer-events-none p-4 md:p-6 flex justify-center">
            <motion.nav
                layout
                ...
                className={cn(
                    "relative pointer-events-auto bg-background/80 backdrop-blur-lg border border-border/50 shadow-lg/2 rounded-lg overflow-hidden", // Added overflow-hidden and changed rounded
        ...
        <div 
            ref={containerRef}
            className="w-full h-full [&::-webkit-scrollbar]:hidden overflow-y-auto overflow-x-hidden relative"
        >
            <div className="min-h-[150vh] w-full p-8 flex flex-col items-center pt-32 space-y-12 text-center text-muted-foreground">
                <p className="text-sm uppercase tracking-widest font-mono">Scroll down to see the effect</p>
